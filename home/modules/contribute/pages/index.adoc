= Contributing to the Red Hat Documentation
// Settings
:hide-uri-scheme:
// URLs
...
Thank you for taking the time and effort to improve the Red Hat documentation.

== Reporting Bugs and Requesting Enhancements

All bugs and enhancements for the Red Hat documentation are tracked using the {url-issues-doc}[DOC project issue board^].
...
Remember, the documentation team are not experts in every aspect of Red Hat.
